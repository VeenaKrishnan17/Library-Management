...
class transaction(db.Model):
    ...
    date_of_issue=db.Column(db.Date,default=datetime.utcnow,nullable=False)
...
def postTrans():
    ...
    transactions = transaction(book_id=TransData['book_id'], stu_id=TransData['stu_id'], Action=TransData['Action'],due_date=TransData['due_date'])
